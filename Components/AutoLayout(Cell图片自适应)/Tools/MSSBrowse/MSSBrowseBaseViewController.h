...
- (void)showBrowseViewController; // 仅push层次下才能show vc


/**
  解决从tabbarViewCotroller present 跳转过来不能showVC的情况。 
  ⚠️ 需要 设置 visibleVC
 */
- (void)showBrowseViewControllerWithPresent:(UIViewController *)vc;
